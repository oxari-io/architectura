...
from preprocessors.core import FastIndustryNormalisationBaselinePreprocessor
            ...
            for tg_scaler in tg_configurations:
                for ft_reducer in ft_reducers:
                    ...
                    ppl1 = DefaultPipeline(
                        preprocessor=FastIndustryNormalisationBaselinePreprocessor(fin_transformer=ft_scaler),
