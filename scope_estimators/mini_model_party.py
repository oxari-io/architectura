...
class SingleModelBucketRegressorOptimizer(RegressorOptimizer):
...
class MiniModelPartyEstimator(MiniModelArmyEstimator):
    ...
    def __init__(self, n_buckets=5, cls={}, rgs={}, **kwargs):
        ...
        self.bucket_rg: BucketRegressor = BucketRegressor().set_optimizer(SingleModelBucketRegressorOptimizer(n_trials=self.n_trials,
