...
df_results_first = pd.read_csv(cwd.parent/'local/eval_results/experiment_bucket_classifier.csv', index_col=0)[1:]
...
plt.show()
# %%
ax = sns.scatterplot(data=df_results, x="test.classifier.balanced_f1", y="mae", hue="configuration")
ax.set_ylim(0, 0.2e6)
plt.show()
