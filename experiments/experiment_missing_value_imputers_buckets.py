...
if __name__ == "__main__":
    ...
    buckets = [3, 5, 7, 9, 11]
    references = [
        'ft_numc_total_assets', 'ft_numc_revenue', 'ft_numc_net_income', 'ft_numc_inventories', 'ft_numc_roe', 'ft_numc_ppe', 'ft_numc_equity',
        'ft_numc_total_liabilities', 'ft_numc_common_stock', 'ft_numc_cash_and_cash_equivalents'
    ]
    ...
    configurations: list[OxariImputer] = [
        ...
        *[
            RImputer(reference=ref, buckets_number=num) for RImputer in [NumericalStatisticsImputer, NumericalStatisticsQuantileBucketImputer] for num in buckets
